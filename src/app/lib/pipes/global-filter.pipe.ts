...
export class GlobalFilterPipe implements PipeTransform {
  ...
  transform(value: any, filterString: string): any {
    ...
    //Si la valeur est vide ou si la chaine de recherche est vide, on supprime le filtre
    if (value.lenght == 0 || filterString === '')
      return value;


    //Pour chaque élément de la liste reçue en paramètre, on vérifie si la chaine de recherche est présente dans l'élément
